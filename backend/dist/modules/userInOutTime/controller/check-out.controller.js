...
const checkOutHandler = async (req, res) => {
    try {
        ...
        const file = req.file;
        if (!file?.path) {
            (0, response_utils_1.sendError)(res, 'Live face photo is required for Punch Out');
            return;
        }
        ...
        const row = await (0, check_out_service_1.checkOut)(userId, relativePhotoPath, { actorUserId, actorRole }, punchLocation);
