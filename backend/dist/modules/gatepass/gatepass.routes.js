...
router.get('/analytics/lunch/range', (0, role_middleware_1.requireRole)('admin'), GatepassController.getLunchAnalyticsRangeReport);
...
router.get('/analytics/lunch/details/:userId', (0, role_middleware_1.requireRole)('admin'), GatepassController.getLunchEmployeeDetailReport);
